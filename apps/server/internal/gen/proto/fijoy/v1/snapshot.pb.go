...
var file_fijoy_v1_snapshot_proto_rawDesc = []byte{
	...
	0x02, 0x01, 0x42, 0x89, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x69, 0x6a, 0x6f, 0x79,
	0x2e, 0x76, 0x31, 0x42, 0x0d, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x50, 0x72, 0x6f,
...
func file_fijoy_v1_snapshot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fijoy_v1_snapshot_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*OverallSnapshotList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fijoy_v1_snapshot_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GetOverallSnapshotsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fijoy_v1_snapshot_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*AccountSnapshotList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fijoy_v1_snapshot_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*GetAccountSnapshotsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
