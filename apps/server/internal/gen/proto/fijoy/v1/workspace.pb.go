...
var file_fijoy_v1_workspace_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x65, 0x32, 0xfe, 0x03, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	...
	0x70, 0x61, 0x63, 0x65, 0x42, 0x8a, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x69, 0x6a,
	0x6f, 0x79, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65,
...
var file_fijoy_v1_workspace_proto_depIdxs = []int32{
	...
	0, // 8: fijoy.v1.WorkspaceService.CreateWorkspace:output_type -> fijoy.v1.Workspace
	1, // 9: fijoy.v1.WorkspaceService.GetWorkspaces:output_type -> fijoy.v1.Workspaces
	0, // 10: fijoy.v1.WorkspaceService.GetWorkspaceById:output_type -> fijoy.v1.Workspace
	0, // 11: fijoy.v1.WorkspaceService.GetWorkspaceByNamespace:output_type -> fijoy.v1.Workspace
	0, // 12: fijoy.v1.WorkspaceService.UpdateWorkspaceName:output_type -> fijoy.v1.Workspace
	0, // 13: fijoy.v1.WorkspaceService.UpdateWorkspaceNamespace:output_type -> fijoy.v1.Workspace
