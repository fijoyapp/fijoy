...
ALTER TABLE "fijoy_transaction" ADD CONSTRAINT "fijoy_transaction_account_id_fijoy_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "fijoy_account" ("id") ON DELETE restrict ON UPDATE no action;
