...
type ComplexityRoot struct {
	Account struct {
		...
		Lmao               func(childComplexity int) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Account.lmao":
		if e.complexity.Account.Lmao == nil {
			break
		}

		return e.complexity.Account.Lmao(childComplexity), true
...
func (ec *executionContext) _Account_lmao(ctx context.Context, field graphql.CollectedField, obj *ent.Account) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Account_lmao(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Account_lmao(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Account",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_AccountEdge_node(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "lmao":
				return ec.fieldContext_Account_lmao(ctx, field)
			case "accountType":
...
func (ec *executionContext) unmarshalInputCreateAccountInput(ctx context.Context, obj any) (ent.CreateAccountInput, error) {
	...
	fieldsInOrder := [...]string{"createTime", "updateTime", "name", "lmao", "accountType", "investmentType", "currencySymbol", "ticker", "tickerType", "amount", "archived", "transactionEntryIDs"}
	for _, k := range fieldsInOrder {
		...
		case "name":
			...
			it.Name = data
		case "lmao":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("lmao"))
			data, err := ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
...
func (ec *executionContext) unmarshalInputUpdateAccountInput(ctx context.Context, obj any) (ent.UpdateAccountInput, error) {
	...
	fieldsInOrder := [...]string{"updateTime", "name", "lmao", "investmentType", "amount", "archived", "addTransactionEntryIDs", "removeTransactionEntryIDs", "clearTransactionEntries"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Account(ctx context.Context, sel ast.SelectionSet, obj *ent.Account) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "lmao":
			out.Values[i] = ec._Account_lmao(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "accountType":
