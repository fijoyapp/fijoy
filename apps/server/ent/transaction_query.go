...
func (_q *TransactionQuery) QueryProfile() *ProfileQuery {
...
func (_q *TransactionQuery) WithProfile(opts ...func(*ProfileQuery)) *TransactionQuery {
	query := (&ProfileClient{config: _q.config}).Query()
...
func (_q *TransactionQuery) loadProfile(ctx context.Context, query *ProfileQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Profile)) error {
