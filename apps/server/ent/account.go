...
type Account struct {
	...
	// Lmao holds the value of the "lmao" field.
	Lmao string `json:"lmao,omitempty"`
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldName, account.FieldLmao, account.FieldAccountType, account.FieldInvestmentType, account.FieldCurrencySymbol, account.FieldTicker, account.FieldTickerType:
...
func (a *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldLmao:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field lmao", values[i])
			} else if value.Valid {
				a.Lmao = value.String
			}
...
func (a *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("lmao=")
	builder.WriteString(a.Lmao)
	builder.WriteString(", ")
