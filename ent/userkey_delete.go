...
func (_d *UserKeyDelete) Where(ps ...predicate.UserKey) *UserKeyDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *UserKeyDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *UserKeyDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *UserKeyDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the UserKeyDelete builder.
func (_d *UserKeyDeleteOne) Where(ps ...predicate.UserKey) *UserKeyDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *UserKeyDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *UserKeyDeleteOne) ExecX(ctx context.Context) {
