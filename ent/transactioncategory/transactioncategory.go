...
const (
	// Label holds the string label denoting the transactioncategory type in the database.
	Label = "transaction_category"
	...
	// Table holds the table name of the transactioncategory in the database.
	Table = "transaction_categories"
	// HouseholdTable is the table that holds the household relation/edge.
	HouseholdTable = "transaction_categories"
	...
	TransactionsColumn = "transaction_category_transactions"
)

// Columns holds all SQL columns for transactioncategory fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the TransactionCategory queries.
